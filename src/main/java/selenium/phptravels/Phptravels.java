...
public class Phptravels {
	...
	public void site() throws IOException {
		...
		FileInputStream locator=new FileInputStream(System.getProperty("user.dir")+"//src//test//java//SelaniumProject//Project//phpTravelsLocators.properties");
		Locators=new Properties();
		Locators.load(locator);
		FileInputStream data=new FileInputStream(System.getProperty("user.dir")+"//src//test//java//SelaniumProject//Project//phpTravelsData.properties");
		Data=new Properties();
		Data.load(data);
